...
const WorkStatusCard = () => {
    ...
    return (
        <Widget styleName="gx-card-img gx-card-cover-black" hoverable
                title={<h1 className="gx-font-weight-bold gx-mb-1 gx-fs-xxl">76% <i
                ...
                cover={
                    <ResponsiveContainer className="gx-bg-dark" width="100%" height={80}>
                        <AreaChart data={data}
                            ...
                            <Tooltip/>
                            <Area type='monotone' dataKey="thisWeek" stackId="2" stroke='#FE9E15' fill='#FE9E15'
                                  fillOpacity={1}/>
                            <Area type='monotone' dataKey='lastWeek' stackId="1" stroke='##956FE7' fill='##956FE7'
                                  fillOpacity={1}/>
                        </AreaChart>
                    </ResponsiveContainer>
                }>
