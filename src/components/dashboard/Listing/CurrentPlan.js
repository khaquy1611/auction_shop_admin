        ...
        <Widget title={<h2 className="h4 gx-text-capitalize gx-mb-0">Your Current Plan</h2>}
            ...
            <div className="gx-currentplan-row">
                <div className="gx-currentplan-col">
                    ...
                    <p className="gx-mb-1"><span
                        className="gx-size-8 gx-bg-dark gx-rounded-xs gx-d-inline-block gx-mr-1"/> Max
                        listing items 2K</p>
                    <p><span className="gx-size-8 gx-bg-dark gx-rounded-xs gx-d-inline-block gx-mr-1"/> Max agents - 10
                    </p>
                </div>
