        ...
        <div className="gx-layout-sider-header">
            ...
            <Link to="/" className="gx-site-logo">
                {navStyle === NAV_STYLE_NO_HEADER_MINI_SIDEBAR && width >= TAB_SIZE ?
                    <img alt="lo" src={("/assets/images/listen-logo.png")} width={100}/> :
                    themeType === THEME_TYPE_LITE ?
                        <img alt="logo1" src={("/assets/images/listen-logo.png")} width={100}/> :
                        <img alt="logo2" src={("/assets/images/listen-logo.png")} width={100}/>}
            </Link>
        </div>
    );
};
